      ...
      <div class="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
        ...
        <div class="md:flex md:items-center md:justify-between">
          ...
          <ul class="flex mb-4 md:order-2 md:ml-4 md:mb-0">
            <li>
              <a class="flex justify-center items-center text-white bg-indigo-500 dark:text-indigo-500 dark:bg-gray-800 hover:underline hover:bg-indigo-600 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Twitter">
            ...
            <li class="ml-4">
              <a class="flex justify-center items-center text-white bg-indigo-500 dark:text-indigo-500 dark:bg-gray-800 hover:underline hover:bg-indigo-600 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Github">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="ml-4">
              <a class="flex justify-center items-center text-white bg-indigo-500 dark:text-indigo-500 dark:bg-gray-800 hover:underline hover:bg-indigo-600 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Facebook">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="ml-4">
              <a class="flex justify-center items-center text-white bg-indigo-500 dark:text-indigo-500 dark:bg-gray-800 hover:underline hover:bg-indigo-600 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Instagram">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="ml-4">
              <a class="flex justify-center items-center text-white bg-indigo-500 dark:text-indigo-500 dark:bg-gray-800 hover:underline hover:bg-indigo-600 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Linkedin">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
